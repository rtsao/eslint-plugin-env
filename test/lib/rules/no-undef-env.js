/**
 * @fileoverview Tests for no-undef-env rule.
 * @author Ryan Tsao
 */
...
const rule = require('../../../lib/rules/no-undef-env');
...
ruleTester.run("no-undef-env", rule, {
    valid: [
        // env stuff
        "function a(){}if (APP_ENV === 'browser') {a(window)}",
        "function a(){}if (APP_ENV === 'node') {a(__dirname)}",
